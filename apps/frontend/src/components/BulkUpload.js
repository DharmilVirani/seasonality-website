            ...
            >
                ...
                {!batchStatus ? (
                    <div className='space-y-4'>
                        <FaCloudUploadAlt
                            className={`mx-auto text-5xl ${dragActive ? 'text-blue-500' : 'text-gray-400'}`}
                        />
                    ...
                    <div className='space-y-4'>
                        <div className='flex items-center justify-between'>
                            ...
                            <span
                                className={`px-3 py-1 rounded-full text-sm font-medium ${getStatusBadge(batchStatus.status)}`}
                            >
                                {batchStatus.status}
                            </span>
                        </div>
                                    ...
                                    <tbody>
                                        {batchStatus.files.map((file, i) => (
                                            <tr key={i} className='border-b border-gray-100'>
                                                ...
                                                <td className='p-2'>
                                                    <span
                                                        className={`inline-flex items-center ${getStatusBadge(file.status)} px-2 py-0.5 rounded text-xs`}
                                                    >
